---
title: What is Web5 and Why Does it Matter? 
...
If you would love to learn more, please check out the [web5-wips](https://github.com/web5fans/web5-wips), which is a collection of Web5 Improvement Proposals (WIPs) that describe standards and protocols for the web5 tech stack. Join [the discussion](https://discord.gg/web5fans) here.
