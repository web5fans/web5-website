---
title: did:ckb PDS
description: Implementation guidance for did:ckb Personal Data Server (PDS) integration with Nervos CKB
---

This document provides comprehensive implementation guidance for the did:ckb PDS (Personal Data Server) system, which extends the AT Protocol infrastructure to support the `did:ckb` DID method through integration with the Nervos CKB blockchain.
